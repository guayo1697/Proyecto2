...
<style type="text/css">
  ...
  <body>
    ...
    <br>
    <center>
    <H1><font face="Comic Sans MS,arial,verdana"><P style="color:#8b4513; background-color:#ffe4c4;width:500px"> Nuevo Departamento </P></H1></font>
    </center>
    <br>
    <br>
    <br>
...
?>
       <br>
       <br>
       <b>Nombre de Departamento: </b>
       <br>
       <br>
       <input type="text" name="nombre" maxlength="30" required = required ><br><br>
       <br>
       <br>
