...
<style type="text/css">
  ...
  <body>
    ...
    <br>
    <center>
    <H1><font face="Comic Sans MS,arial,verdana"><P style="color:#8b4513; background-color:#ffe4c4;width:500px"> Nuevo Permiso </P></H1></font>
    </center>
    <br>
    <br>
    <br>
  ...
  <center>
     ...
     <form action="NPDB.php" method="get">
...
?>
       ...
       <br>
       <br>
       <input type="text" name="motivo" maxlength="100" required = required style="height: 25px; width: 300px;"><br><br>
       <br>
       <br>
